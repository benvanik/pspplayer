			...
			namespace Bios {
				namespace Modules {
					...
					public: // So many they are all inline... good luck!
						...
						int sceKernelAllocateVpl( IMemory^ memory, int uid, int size, int data, int timeout );
						...
						int sceKernelCancelVpl( IMemory^ memory, int uid, int pnum );
						...
						int sceKernelReferVplStatus( IMemory^ memory, int uid, int info );
						...
						int sceKernelCreateFpl( IMemory^ memory, int name, int part, int attr, int size, int blocks, int opt );
