	...
	namespace Emulation {
		namespace Psp {
			namespace Cpu {
				...
				ref class R4000Cp1 : R4000Coprocessor
				{
				protected:
					...
					{
					public:
						array<double>^ GeneralRegisters;
						int ControlRegister;
					};

				public:

					R4000Cp1( R4000Core^ core )
					...
					property array<double>^ Registers;
					...
					property Object^ Context
					{
						virtual Object^ get() override
						{
							...
							context->GeneralRegisters = ( array<double>^ )Registers->Clone();
							return context;
						}
						virtual void set( Object^ value ) override
						{
							...
							Registers = ( array<double>^ )context->GeneralRegisters->Clone();
						}
					}
