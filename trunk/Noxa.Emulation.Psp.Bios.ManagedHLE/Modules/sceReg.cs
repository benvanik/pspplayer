...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceReg : Module
	{
		...
		public int sceRegOpenRegistry( int reg, int mode, int h ){ return Module.NotImplementedReturn; }
		...
		public int sceRegCloseRegistry( int h ){ return Module.NotImplementedReturn; }
		...
		public int sceRegOpenCategory( int h, int name, int mode, int hd ){ return Module.NotImplementedReturn; }
		...
		public int sceRegCloseCategory( int hd ){ return Module.NotImplementedReturn; }
		...
		public int sceRegGetKeyInfo( int hd, int name, int hk, int type, int size ){ return Module.NotImplementedReturn; }
		...
		public int sceRegGetKeyValue( int hd, int hk, int buf, int size ){ return Module.NotImplementedReturn; }
