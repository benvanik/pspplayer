...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceHprm : Module
	{
		...
		int sceHprmPeekCurrentKey( int key ){ return Module.NotImplementedReturn; }
		...
		int sceHprmPeekLatch( int latch ){ return Module.NotImplementedReturn; }
		...
		int sceHprmReadLatch( int latch ){ return Module.NotImplementedReturn; }
