...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class ModuleMgrForUser : Module
	{
		...
		public int sceKernelLoadModuleByID( int fid, int flags, int option ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelLoadModule( int path, int flags, int option ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelLoadModuleMs( int path, int flags, int option ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelStartModule( int modid, int argsize, int argp, int status, int option ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelStopModule( int modid, int argsize, int argp, int status, int option ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelUnloadModule( int modid ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelSelfStopUnloadModule( int unknown, int argsize, int argp ){ return Module.NotImplementedReturn; }
		...
		public int sceKernelStopUnloadSelfModule( int argsize, int argp, int status, int option ){ return Module.NotImplementedReturn; }
