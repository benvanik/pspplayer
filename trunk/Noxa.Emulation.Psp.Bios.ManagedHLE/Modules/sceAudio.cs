...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceAudio : Module
	{
		...
		int sceAudioOutput( int channel, int vol, int buf ){ return Module.NotImplementedReturn; }
		...
		int sceAudioOutputBlocking( int channel, int vol, int buf ){ return Module.NotImplementedReturn; }
		...
		int sceAudioOutputPanned( int channel, int leftvol, int rightvol, int buffer ){ return Module.NotImplementedReturn; }
		...
		int sceAudioOutputPannedBlocking( int channel, int leftvol, int rightvol, int buffer ){ return Module.NotImplementedReturn; }
		...
		int sceAudioChReserve( int channel, int samplecount, int format ){ return Module.NotImplementedReturn; }
		...
		int sceAudioChRelease( int channel ){ return Module.NotImplementedReturn; }
		...
		int sceAudioGetChannelRestLen( int channel ){ return Module.NotImplementedReturn; }
		...
		int sceAudioSetChannelDataLen( int channel, int samplecount ){ return Module.NotImplementedReturn; }
		...
		int sceAudioChangeChannelConfig( int channel, int format ){ return Module.NotImplementedReturn; }
		...
		int sceAudioChangeChannelVolume( int channel, int leftvol, int rightvol ){ return Module.NotImplementedReturn; }
