...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceUsb : Module
	{
		...
		public int sceUsbStart( int driverName, int size, int args ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbStop( int driverName, int size, int args ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbGetState(){ return Module.NotImplementedReturn; }
		...
		public int sceUsbGetDrvList( int r4one, int r5ret, int r6one ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbGetDrvState( int driverName ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbActivate( int pid ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbDeactivate( int pid ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbWaitState( int state, int waitmode, int timeout ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbWaitCancel(){ return Module.NotImplementedReturn; }
