...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class ThreadManForUser : Module
	{
		...
		int sceKernelRegisterThreadEventHandler( int name, int threadID, int mask, int handler, int common ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReleaseThreadEventHandler( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferThreadEventHandlerStatus( int uid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateCallback( int name, int func, int arg ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteCallback( int cb ){ return Module.NotImplementedReturn; }
		...
		int sceKernelNotifyCallback( int cb, int arg2 ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelCallback( int cb ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetCallbackCount( int cb ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferCallbackStatus( int cb, int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWakeupThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelWakeupThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSuspendThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelResumeThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitThreadEnd( int thid, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitThreadEndCB( int thid, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDelayThread( int delay ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDelayThreadCB( int delay ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDelaySysClockThread( int delay ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDelaySysClockThreadCB( int delay ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateSema( int name, int attr, int initVal, int maxVal, int option ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteSema( int semaid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSignalSema( int semaid, int signal ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitSema( int semaid, int signal, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitSemaCB( int semaid, int signal, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelPollSema( int semaid, int signal ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferSemaStatus( int semaid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateEventFlag( int name, int attr, int bits, int opt ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteEventFlag( int evid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetEventFlag( int evid, int bits ){ return Module.NotImplementedReturn; }
		...
		int sceKernelClearEventFlag( int evid, int bits ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitEventFlag( int evid, int bits, int wait, int outBits, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelWaitEventFlagCB( int evid, int bits, int wait, int outBits, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelPollEventFlag( int evid, int bits, int wait, int outBits ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferEventFlagStatus( int evid, int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateMbx( int name, int attr, int option ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteMbx( int mbxid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSendMbx( int mbxid, int message ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReceiveMbx( int mbxid, int pmessage, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReceiveMbxCB( int mbxid, int pmessage, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelPollMbx( int mbxid, int pmessage ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelReceiveMbx( int mbxid, int pnum ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferMbxStatus( int mbxid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateMsgPipe( int name, int part, int attr, int unk1, int opt ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteMsgPipe( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSendMsgPipe( int uid, int message, int size, int unk1, int unk2, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSendMsgPipeCB( int uid, int message, int size, int unk1, int unk2, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTrySendMsgPipe( int uid, int message, int size, int unk1, int unk2 ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReceiveMsgPipe( int uid, int message, int size, int unk1, int unk2, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReceiveMsgPipeCB( int uid, int message, int size, int unk1, int unk2, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTryReceiveMsgPipe( int uid, int message, int size, int unk1, int unk2 ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelMsgPipe( int uid, int psend, int precv ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferMsgPipeStatus( int uid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateVpl( int name, int part, int attr, int size, int opt ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteVpl( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelAllocateVpl( int uid, int size, int data, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelAllocateVplCB( int uid, int size, int data, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTryAllocateVpl( int uid, int size, int data ){ return Module.NotImplementedReturn; }
		...
		int sceKernelFreeVpl( int uid, int data ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelVpl( int uid, int pnum ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferVplStatus( int uid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateFpl( int name, int part, int attr, int size, int blocks, int opt ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteFpl( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelAllocateFpl( int uid, int data, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelAllocateFplCB( int uid, int data, int timeout ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTryAllocateFpl( int uid, int data ){ return Module.NotImplementedReturn; }
		...
		int sceKernelFreeFpl( int uid, int data ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelFpl( int uid, int pnum ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferFplStatus( int uid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUSec2SysClock( int usec, int clock ){ return Module.NotImplementedReturn; }
		...
		long sceKernelUSec2SysClockWide( int usec ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSysClock2USec( int clock, int low, int high ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSysClock2USecWide( long clock, int low, int high ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetSystemTime( int time ){ return Module.NotImplementedReturn; }
		...
		long sceKernelGetSystemTimeWide(){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetAlarm( int clock, int handler, int common ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetSysClockAlarm( int clock, int handler, int common ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelAlarm( int alarmid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferAlarmStatus( int alarmid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateVTimer( int name, int opt ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteVTimer( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetVTimerBase( int uid, int clockBase ){ return Module.NotImplementedReturn; }
		...
		long sceKernelGetVTimerBaseWide( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetVTimerTime( int uid, int time ){ return Module.NotImplementedReturn; }
		...
		long sceKernelGetVTimerTimeWide( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetVTimerTime( int uid, int time ){ return Module.NotImplementedReturn; }
		...
		long sceKernelSetVTimerTimeWide( int uid, long time ){ return Module.NotImplementedReturn; }
		...
		int sceKernelStartVTimer( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelStopVTimer( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetVTimerHandler( int uid, int time, int handler, int common ){ return Module.NotImplementedReturn; }
		...
		int sceKernelSetVTimerHandlerWide( int uid, long time, int handler, int common ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCancelVTimerHandler( int uid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferVTimerStatus( int uid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelCreateThread( int name, int entry, int initPriority, int stackSize, int attr, int option ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDeleteThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelStartThread( int thid, int arglen, int argp ){ return Module.NotImplementedReturn; }
		...
		int sceKernelExitThread( int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelExitDeleteThread( int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTerminateThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelTerminateDeleteThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelResumeDispatchThread( int state ){ return Module.NotImplementedReturn; }
		...
		int sceKernelChangeCurrentThreadAttr( int unknown, int attr ){ return Module.NotImplementedReturn; }
		...
		int sceKernelChangeThreadPriority( int thid, int priority ){ return Module.NotImplementedReturn; }
		...
		int sceKernelRotateThreadReadyQueue( int priority ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReleaseWaitThread( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetThreadExitStatus( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetThreadStackFreeSize( int thid ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferThreadStatus( int thid, int info ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferThreadRunStatus( int thid, int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelReferSystemStatus( int status ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetThreadmanIdList( int type, int readbuf, int readbufsize, int idcount ){ return Module.NotImplementedReturn; }
		...
		int sceKernelGetThreadmanIdType( int uid ){ return Module.NotImplementedReturn; }
