...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceUsbstorBoot : Module
	{
		...
		public int sceUsbstorBootSetCapacity( int size ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbstorBootSetLoadAddr( int addr ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbstorBootGetDataSize(){ return Module.NotImplementedReturn; }
		...
		public int sceUsbstorBootSetStatus( int status ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbstorBootRegisterNotify( int eventFlag ){ return Module.NotImplementedReturn; }
		...
		public int sceUsbstorBootUnregisterNotify( int eventFlag ){ return Module.NotImplementedReturn; }
