...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	...
	class sceAtrac3plus : Module
	{
		...
		public int sceAtracDecodeData( int atracID, int outSamples, int outN, int outEnd, int outRemainFrame ){ return DummyReturn; }
		...
		public int sceAtracGetRemainFrame( int atracID, int outRemainFrame ){ return DummyReturn; }
