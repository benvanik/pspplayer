...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class IoFileMgrForUser : Module
	{
		...
		int sceIoPollAsync( int fd, long res ){ return Module.NotImplementedReturn; }
		...
		int sceIoWaitAsync( int fd, long res ){ return Module.NotImplementedReturn; }
		...
		int sceIoWaitAsyncCB( int fd, long res ){ return Module.NotImplementedReturn; }
		...
		int sceIoGetAsyncStat( int fd, int poll, long res ){ return Module.NotImplementedReturn; }
		...
		int sceIoChangeAsyncPriority( int fd, int pri ){ return Module.NotImplementedReturn; }
		...
		int sceIoSetAsyncCallback( int fd, int cb, int argp ){ return Module.NotImplementedReturn; }
		...
		int sceIoClose( int fd ){ return Module.NotImplementedReturn; }
		...
		int sceIoCloseAsync( int fd ){ return Module.NotImplementedReturn; }
		...
		int sceIoOpen( int file, int flags, int mode ){ return Module.NotImplementedReturn; }
		...
		int sceIoOpenAsync( int file, int flags, int mode ){ return Module.NotImplementedReturn; }
		...
		int sceIoRead( int fd, int data, int size ){ return Module.NotImplementedReturn; }
		...
		int sceIoReadAsync( int fd, int data, int size ){ return Module.NotImplementedReturn; }
		...
		int sceIoWrite( int fd, int data, int size ){ return Module.NotImplementedReturn; }
		...
		int sceIoWriteAsync( int fd, int data, int size ){ return Module.NotImplementedReturn; }
		...
		long sceIoLseek( int fd, long offset, int whence ){ return Module.NotImplementedReturn; }
		...
		int sceIoLseekAsync( int fd, long offset, int whence ){ return Module.NotImplementedReturn; }
		...
		int sceIoLseek32( int fd, int offset, int whence ){ return Module.NotImplementedReturn; }
		...
		int sceIoLseek32Async( int fd, int offset, int whence ){ return Module.NotImplementedReturn; }
		...
		int sceIoIoctl( int fd, int cmd, int indata, int inlen, int outdata, int outlen ){ return Module.NotImplementedReturn; }
		...
		int sceIoIoctlAsync( int fd, int cmd, int indata, int inlen, int outdata, int outlen ){ return Module.NotImplementedReturn; }
		...
		int sceIoDopen( int dirname ){ return Module.NotImplementedReturn; }
		...
		int sceIoDread( int fd, int dir ){ return Module.NotImplementedReturn; }
		...
		int sceIoDclose( int fd ){ return Module.NotImplementedReturn; }
		...
		int sceIoRemove( int file ){ return Module.NotImplementedReturn; }
		...
		int sceIoMkdir( int dir, int mode ){ return Module.NotImplementedReturn; }
		...
		int sceIoRmdir( int path ){ return Module.NotImplementedReturn; }
		...
		int sceIoChdir( int path ){ return Module.NotImplementedReturn; }
		...
		int sceIoSync( int device, int unk ){ return Module.NotImplementedReturn; }
		...
		int sceIoGetstat( int file, int stat ){ return Module.NotImplementedReturn; }
		...
		int sceIoChstat( int file, int stat, int bits ){ return Module.NotImplementedReturn; }
		...
		int sceIoRename( int oldname, int newname ){ return Module.NotImplementedReturn; }
		...
		int sceIoDevctl( int dev, int cmd, int indata, int inlen, int outdata, int outlen ){ return Module.NotImplementedReturn; }
		...
		int sceIoGetDevType( int fd ){ return Module.NotImplementedReturn; }
		...
		int sceIoAssign( int dev1, int dev2, int dev3, int mode, int unk1, int unk2 ){ return Module.NotImplementedReturn; }
		...
		int sceIoUnassign( int dev ){ return Module.NotImplementedReturn; }
		...
		int sceIoCancel( int fd ){ return Module.NotImplementedReturn; }
