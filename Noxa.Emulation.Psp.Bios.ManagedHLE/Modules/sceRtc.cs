...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class sceRtc : Module
	{
		...
		public int sceRtcGetTickResolution(){ return Module.NotImplementedReturn; }
		...
		public int sceRtcGetCurrentTick( int tick ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcGetCurrentClock( int time, int tz ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcGetCurrentClockLocalTime( int time ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcConvertUtcToLocalTime( int tickUTC, int tickLocal ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcConvertLocalTimeToUTC( int tickLocal, int tickUTC ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcIsLeapYear( int year ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcGetDaysInMonth( int year, int month ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcGetDayOfWeek( int year, int month, int day ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcCheckValid( int date ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcCompareTick( int tick1, int tick2 ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddTicks( int destTick, int srcTick, int numTicks ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddMicroseconds( int destTick, int srcTick, int numMS ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddSeconds( int destTick, int srcTick, int numSecs ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddMinutes( int destTick, int srcTick, int numMins ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddHours( int destTick, int srcTick, int numHours ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddDays( int destTick, int srcTick, int numDays ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddWeeks( int destTick, int srcTick, int numWeeks ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddMonths( int destTick, int srcTick, int numMonths ){ return Module.NotImplementedReturn; }
		...
		public int sceRtcTickAddYears( int destTick, int srcTick, int numYears ){ return Module.NotImplementedReturn; }
