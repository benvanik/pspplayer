...
namespace Noxa.Emulation.Psp.Bios.ManagedHLE.Modules
{
	class UtilsForUser : Module
	{
		...
		int sceKernelUtilsMd5Digest( int data, int size, int digest ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsMd5BlockInit( int ctx ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsMd5BlockUpdate( int ctx, int data, int size ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsMd5BlockResult( int ctx, int digest ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsSha1Digest( int data, int size, int digest ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsSha1BlockInit( int ctx ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsSha1BlockUpdate( int ctx, int data, int size ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsSha1BlockResult( int ctx, int digest ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsMt19937Init( int ctx, int seed ){ return Module.NotImplementedReturn; }
		...
		int sceKernelUtilsMt19937UInt( int ctx ){ return Module.NotImplementedReturn; }
		...
		int sceKernelLibcTime( int t ){ return Module.NotImplementedReturn; }
		...
		int sceKernelLibcGettimeofday( int tp, int tzp ){ return Module.NotImplementedReturn; }
		...
		int sceKernelDcacheProbe( int addr ){ return Module.NotImplementedReturn; }
		...
		int sceKernelIcacheProbe( int addr ){ return Module.NotImplementedReturn; }
